                            ...
                            <div class="col-md-6 mx-auto">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <hr/>
                                        <form method="post" action="{{ route('update-address', ['id' => $address->id]) }}">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <input id="mobile_no" name="mobile_no" type="number" class="form-control form-control-sm @error('mobile_no') is-invalid @enderror"
                                                           value="{{ $address->mobile_no }}" placeholder="Mobile No" aria-label="Mobile No" aria-describedby="basic-addon1">
                                                </div>
                                                @error('mobile_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="town" name="town" type="text" class="form-control form-control-sm @error('town') is-invalid @enderror" value="{{ $address->city }}">
                                                @error('town')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
